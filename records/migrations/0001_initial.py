    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ReviewResult', models.CharField(choices=[('1', '通过'), ('2', '未通过'), ('3', '未处理')], default='3', max_length=200, verbose_name='审核结果')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('TransactionStatus', models.CharField(choices=[('1', '待处理'), ('2', '成功'), ('3', '失败')], default='1', max_length=200, verbose_name='交易状态')),
                ('AchievementID', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='create.researchresult', verbose_name='成果ID')),
                ('Buyer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='transaction_buyer', to='login.siteuser', verbose_name='购买方')),
                ('Seller', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='transaction_seller', to='login.siteuser', verbose_name='出售方')),
            ],
            options={
